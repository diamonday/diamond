...
class AWGManager(HasTraits, AWG520):
    ...
    rmod = Enum(
        ...
        editor=EnumEditor(values=rmod_table, format_str="%s mode"),
    )
    ...
    slop = Enum(
        ...
        editor=EnumEditor(values=slop_table, format_str="%s"),
    )
    ...
    del_byRange = Str(
        value="", label="By Range", desc="e.g. input 0:7 to delete the 0th - 7th files"
    )
