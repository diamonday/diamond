...
class TimeTaggerControl(HasTraits):
    ...
    trigger_level_0 = Range(
        low=0.0,
        high=2.5,
        value=0.5,
        desc="trigger level for channel 0 in volts",
        label="trigger level 0 [V]",
    )
    trigger_level_1 = Range(
        low=0.0,
        high=2.5,
        value=0.5,
        desc="trigger level for channel 1 in volts",
        label="trigger level 1 [V]",
    )
    trigger_level_2 = Range(
        low=0.0,
        high=2.5,
        value=0.5,
        desc="trigger level for channel 2 in volts",
        label="trigger level 2 [V]",
    )
    trigger_level_3 = Range(
        low=0.0,
        high=2.5,
        value=0.5,
        desc="trigger level for channel 3 in volts",
        label="trigger level 3 [V]",
    )
    trigger_level_4 = Range(
        low=0.0,
        high=2.5,
        value=0.5,
        desc="trigger level for channel 4 in volts",
        label="trigger level 4 [V]",
    )
    trigger_level_5 = Range(
        low=0.0,
        high=2.5,
        value=0.5,
        desc="trigger level for channel 5 in volts",
        label="trigger level 5 [V]",
    )
    trigger_level_6 = Range(
        low=0.0,
        high=2.5,
        value=0.5,
        desc="trigger level for channel 6 in volts",
        label="trigger level 6 [V]",
    )
    trigger_level_7 = Range(
        low=0.0,
        high=2.5,
        value=0.5,
        desc="trigger level for channel 7 in volts",
        label="trigger level 7 [V]",
    )

    count_rate_0 = Float(
        default_value=0.0,
        desc="count rate for channel 0 in volts",
        label="count rate 0 [1/s]",
    )
    count_rate_1 = Float(
        default_value=0.0,
        desc="count rate for channel 1 in volts",
        label="count rate 1 [1/s]",
    )
    count_rate_2 = Float(
        default_value=0.0,
        desc="count rate for channel 2 in volts",
        label="count rate 2 [1/s]",
    )
    count_rate_3 = Float(
        default_value=0.0,
        desc="count rate for channel 3 in volts",
        label="count rate 3 [1/s]",
    )
    count_rate_4 = Float(
        default_value=0.0,
        desc="count rate for channel 4 in volts",
        label="count rate 4 [1/s]",
    )
    count_rate_5 = Float(
        default_value=0.0,
        desc="count rate for channel 5 in volts",
        label="count rate 5 [1/s]",
    )
    count_rate_6 = Float(
        default_value=0.0,
        desc="count rate for channel 6 in volts",
        label="count rate 6 [1/s]",
    )
    count_rate_7 = Float(
        default_value=0.0,
        desc="count rate for channel 7 in volts",
        label="count rate 7 [1/s]",
    )

    enable_filter = Bool(
        desc="Enable sync filter for channel 7. Events are filtered against channel 0."
    )

    refresh_interval = Range(
        low=0.01,
        high=1,
        value=0.5,
    ...
    def __init__(self, time_tagger, **kwargs):
        ...
        self._stoppable_thread = StoppableThread(
            target=TimeTaggerControl._run, args=(weakref.proxy(self),)
        )
    ...
    def _enable_filter_default(self):
        return self.time_tagger.getLaserFilter()

    def _enable_filter_changed(self, new):
        self.time_tagger.setLaserFilter(new)
    ...
    traits_view = View(
        Group(
            ...
            Label("0"),
            Item("trigger_level_0", show_label=False),
            Item(
                "count_rate_0",
                show_label=False,
                style="readonly",
            ...
            Label("1"),
            Item("trigger_level_1", show_label=False),
            Item(
                "count_rate_1",
                show_label=False,
                style="readonly",
            ...
            Label("2"),
            Item("trigger_level_2", show_label=False),
            Item(
                "count_rate_2",
                show_label=False,
                style="readonly",
            ...
            Label("3"),
            Item("trigger_level_3", show_label=False),
            Item(
                "count_rate_3",
                show_label=False,
                style="readonly",
            ...
            Label("4"),
            Item("trigger_level_4", show_label=False),
            Item(
                "count_rate_4",
                show_label=False,
                style="readonly",
            ...
            Label("5"),
            Item("trigger_level_5", show_label=False),
            Item(
                "count_rate_5",
                show_label=False,
                style="readonly",
            ...
            Label("6"),
            Item("trigger_level_6", show_label=False),
            Item(
                "count_rate_6",
                show_label=False,
                style="readonly",
            ...
            Label("7"),
            Item("trigger_level_7", show_label=False),
            Item(
                "count_rate_7",
                show_label=False,
                style="readonly",
