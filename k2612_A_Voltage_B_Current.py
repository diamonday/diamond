...
class Keithley2612(HasTraits):
    ...
    current = Range(low = -1500, high=1500, value = 0, desc='current[mA]', label='current[mA]', auto_set=False,
    ...
    def _OutputOn_B_fired(self):
        ...
        self.k2612.write("smub.source.leveli = " + str(np.float64(self.current) / 1000.0))
        # self.ReadingV = np.float(self.k2612.ask("print(smua.measure.v())")) * 1000.
        # self.ReadingI = np.float(self.k2612.ask("print(smua.measure.i())")) * 1000.
    ...
    def _Measure_A_fired(self):
        self.ReadingV_A = np.float(self.k2612.ask("print(smua.measure.v())")) * 1000.
        self.ReadingI_A = np.float(self.k2612.ask("print(smua.measure.i())")) * 1000.
    def _Measure_B_fired(self):
        self.ReadingV_B = np.float(self.k2612.ask("print(smub.measure.v())")) * 1000.
        self.ReadingI_B = np.float(self.k2612.ask("print(smub.measure.i())")) * 1000.
