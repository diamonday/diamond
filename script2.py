...
import measurements.Rho23Rabi
reload(measurements.Rho23Rabi)

from measurements.Rho23Rabi import Rho23Rabi
rho23rabi2=Rho23Rabi(pulse_generator=ha.PulseGenerator(), time_tagger=ha.TimeTagger, microwave=ha.Microwave(), awg_rf=ha.AWG610())
rho23rabi2.edit_traits()
"""
"""
import measurements.VQE_2p_3
reload(measurements.VQE_2p_3)

from measurements.VQE_2p_3 import VQE_2p
...
"""
"""
import measurements.VQE_1p
reload(measurements.VQE_1p)
...
import measurements.VQE_1p_N
reload(measurements.VQE_1p_N)
...
import measurements.VQE_1p_diag
reload(measurements.VQE_1p_diag)
...
import measurements.ERabi_TOMO
reload(measurements.ERabi_TOMO)
...
import measurements.NuclearRabi_tomo_heating
reload(measurements.NuclearRabi_tomo_heating)
...
import measurements.auto_focus_trace
reload(measurements.auto_focus_trace)
