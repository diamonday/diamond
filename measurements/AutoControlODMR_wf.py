...
class AutoControlODMR_wf(FreeJob, HasTraits):
    ...
    ODMRPTime = Float(100.0, label="ODMRP integration time [s]")
    ...
    ODMRPPTime = Float(100.0, label="ODMRPP integration time [s]")
    ...
    ODMRNTime = Float(100.0, label="ODMRN integration time [s]")
    ...
    ODMRJTime = Float(100.0, label="ODMRJ integration time [s]")
    ...
    def __init__(self, auto_focus, confocal, odmr, odmrn):
        ...
        print(
            "Welcome to AutoControlODMR_wf! For the SC measurement, please keep the default mw power!!! (SMIQ = -18 dBm)"
        )
    ...
    def performodmrpp(self, TargetID, TargetMWBegin, TargetMWEnd, TargetMWDelta, Ln):
        if self.PerformODMRPP and self.odmrpp:
            ...
            try:
                focusXYZ = open(
                    "focusXYZ_ODMRPP" + str(TargetID) + "_Loop" + str(Ln) + ".txt", "w+"
                )
                focusXYZ.write(
                    "Focus:"
                    + str(self.confocal.x)
                ...
                logging.getLogger().exception(
                    "File could not be saved.(FocusXYZ_ODMRPP)"
                )
    ...
    def performodmrp(self, TargetID, TargetMWBegin, TargetMWEnd, TargetMWDelta, Ln):
        if self.PerformODMRP and self.odmrp:
            ...
            try:
                focusXYZ = open(
                    "focusXYZ_ODMRP" + str(TargetID) + "_Loop" + str(Ln) + ".txt", "w+"
                )
                focusXYZ.write(
                    "Focus:"
                    + str(self.confocal.x)
                ...
                logging.getLogger().exception(
                    "File could not be saved.(FocusXYZ_ODMRP)"
                )
    ...
    def performodmrn(self, TargetID, TargetMWBegin, TargetMWEnd, TargetMWDelta, Ln):
        if self.PerformODMRN and self.odmrn:
            ...
            try:
                focusXYZ = open(
                    "focusXYZ_ODMRN" + str(TargetID) + "_Loop" + str(Ln) + ".txt", "w+"
                )
                focusXYZ.write(
                    "Focus:"
                    + str(self.confocal.x)
                ...
                logging.getLogger().exception(
                    "File could not be saved.(FocusXYZ_ODMRN)"
                )
    ...
    def performodmr(self, TargetID, TargetMWBegin, TargetMWEnd, TargetMWDelta, Ln):
        if self.PerformODMR and self.odmr:
            ...
            try:
                focusXYZ = open(
                    "focusXYZ_ODMR" + str(TargetID) + "_Loop" + str(Ln) + ".txt", "w+"
                )
                focusXYZ.write(
                    "Focus:"
                    + str(self.confocal.x)
    ...
    def performodmrj(self, TargetID, TargetMWBegin, TargetMWEnd, TargetMWDelta, Ln):
        if self.PerformODMRJ and self.odmr:
            powerlist = np.arange(
                self.JMWBegin, self.JMWEnd + self.JMWDelta, self.JMWDelta
            )
            for p in powerlist:
                print(p)
                ...
                try:
                    focusXYZ = open(
                        "focusXYZ_ODMRJ" + str(TargetID) + "_Loop" + str(Ln) + ".txt",
                        "w+",
                    )
                    focusXYZ.write(
                        "Focus:"
                    ...
                    logging.getLogger().exception(
                        "File could not be saved.(FocusXYZ_ODMRJ)"
                    )
    ...
    def _run(self):
        ...
        orderedfunclist = sorted(
            zip(prioritylist, funclist), key=lambda element: element[0]
        )
            ...
            HGroup(
                ...
                Tabbed(
                    VGroup(
                        ...
                        HGroup(
                            Item("PerformODMRPP", enabled_when="odmrpp != None"),
                            Item("ODMRPPOrder", enabled_when="odmrpp != None"),
                        ),
                        HGroup(
                            Item("ODMRPPTime", enabled_when="odmrpp != None"),
                            Item("ODMRPPWaitTime", enabled_when="odmrpp != None"),
                        ),
                        HGroup(
                            Item("PerformODMRP", enabled_when="odmrp != None"),
                        ...
                        HGroup(
                            Item("PerformODMRN", enabled_when="odmrn != None"),
                            Item("ODMRNOrder", enabled_when="odmrp != None"),
                        ),
                        HGroup(
                            Item("ODMRNTime", enabled_when="odmrn != None"),
                        ...
                        VGroup(
                            HGroup(
                                Item("PerformODMRJ", enabled_when="odmr != None"),
                                Item("ODMRJOrder", enabled_when="odmr != None"),
                            ),
                            HGroup(
                                Item("ODMRJTime", enabled_when="odmr != None"),
                                Item("ODMRJWaitTime", enabled_when="odmr != None"),
                            ),
                            HGroup(
                                Item("JMWBegin", enabled_when="odmr != None"),
                        ...
                        VGroup(
                            HGroup(
                                Item("PerformWF", enabled_when="confocal != None"),
                                Item("WFOrder", enabled_when="confocal != None"),
                            ),
                            HGroup(
                                Item("WFMWPower", enabled_when="confocal != None"),
                                Item("WFWaitTime", enabled_when="confocal != None"),
                            ),
                            HGroup(
                                Item("WFMWBegin", enabled_when="confocal != None"),
                                Item("WFMWEnd", enabled_when="confocal != None"),
                            ),
                            HGroup(
                                Item("WFMWDelta", enabled_when="confocal != None"),
                            ),
                        ),
                        label="measure",
                    ),
