...
class VQE_1p(Pulsed):
    ...
    # todo: the order of sequence is a mess, need to get to N1 N2 N3 N4, N0, Npi13, Npi34, NPi and off diad terms. this is also needed in data processing part
    ...
    def __init__(
        self, pulse_generator, time_tagger, microwave, microwave2, awg_rf, **kwargs
    ):
        self.generate_sequence()

        super(VQE_1p, self).__init__(
            pulse_generator, time_tagger, microwave, microwave2, awg_rf, **kwargs
        )
        ...
        try:
            if self.auto_save == True:
                if self.state == "run":
                    ...
                    dir2 = "/vqe_%03.3f_%03.3f_%imin_%i.pys" % (
                        self.rot_n_y,
                        self.rot_n_x,
                        self.saveWaitTime,
    ...
    def generate_heating_time(self):
        ...
        max_time = max(
            hard_pi_t + t_rot + mw_pi + mw_pi_rf,
            mw_pi_rf_12,
            hard_pi_t + t_rot + hard_pi_t + mw_pi2_rf + mw_pi_2,
        )
        ...
        "Tomo 0"
        heating_time.append(max_time - hard_pi_t - t_rot - mw_pi)

        "Tomo pi13"
        heating_time.append(max_time - hard_pi_t - t_rot)

        "Tomo pi34"
        heating_time.append(max_time - hard_pi_t - t_rot - mw_pi - mw_pi_rf)

        "Tomo Pi"
        heating_time.append(max_time - hard_pi_t - t_rot - mw_pi_2)

        "Non-diag terms"
        "rho23 +pi/2"
        heating_time.append(
            max_time - hard_pi_t - t_rot - hard_pi_t - mw_pi2_rf - mw_pi
        )
        ...
        "rho14 +pi/2"
        heating_time.append(max_time - hard_pi_t - t_rot - mw_pi2_rf - mw_pi)
    ...
    def generate_sequence(self):
        ...
        if mw_pi > mw_pi_2:
            ...
            hard_pi_seq = [(["A", "mw_x", "B"], mw_pi), (["B"], mw_pi_2 - mw_pi)]
            hard_pi_t = mw_pi_2
        ...
        diag_sequences[0].append(([], t_rot))
        diag_sequences[0].append((["A", "mw_x"], mw_pi))
        # diag_sequences[0].append(([], max_time - hard_pi_t - t_rot - mw_pi))
        heating_time.append(max_time - hard_pi_t - t_rot - mw_pi)

        "Tomo pi13"
        diag_sequences[1] += hard_pi_seq
        diag_sequences[1].append(([], t_rot))
        # diag_sequences[1].append(([], max_time - hard_pi_t - t_rot))
        heating_time.append(max_time - hard_pi_t - t_rot)

        "Tomo pi34"
        diag_sequences[2] += hard_pi_seq
        diag_sequences[2].append(([], t_rot))
        diag_sequences[2].append((["A", "mw_x"], mw_pi))
        diag_sequences[2].append(([], mw_pi_rf))
        # diag_sequences[2].append(([], max_time - hard_pi_t - t_rot - mw_pi - mw_pi_rf))
        heating_time.append(max_time - hard_pi_t - t_rot - mw_pi - mw_pi_rf)

        "Tomo Pi"
        diag_sequences[3] += hard_pi_seq
        diag_sequences[3].append(([], t_rot))
        diag_sequences[3].append((["B"], mw_pi_2))
        # diag_sequences[3].append(([], max_time - hard_pi_t - t_rot - mw_pi_2))
        heating_time.append(max_time - hard_pi_t - t_rot - mw_pi_2)
        ...
        nondiag_sequences[0].append(([], t_rot))
        nondiag_sequences[0] += hard_pi_seq
        nondiag_sequences[0].append(([], mw_pi2_rf))
        nondiag_sequences[0].append((["A", "mw_x"], mw_pi))
        # nondiag_sequences[0].append(([], max_time - hard_pi_t - t_rot - hard_pi_t - mw_pi2_rf - mw_pi_2))
        heating_time.append(
            max_time - hard_pi_t - t_rot - hard_pi_t - mw_pi2_rf - mw_pi
        )
        ...
        nondiag_sequences[1].append(([], t_rot))
        nondiag_sequences[1] += hard_pi_seq
        nondiag_sequences[1].append(([], mw_pi2_rf))
        nondiag_sequences[1].append((["A", "mw_x"], mw_pi))
        # nondiag_sequences[1].append(([], max_time - hard_pi_t - t_rot - hard_pi_t - mw_pi2_rf - mw_pi_2))
        heating_time.append(
            max_time - hard_pi_t - t_rot - hard_pi_t - mw_pi2_rf - mw_pi
        )
        ...
        nondiag_sequences[2].append(([], t_rot))
        nondiag_sequences[2].append(([], mw_pi2_rf))
        nondiag_sequences[2].append((["A", "mw_x"], mw_pi))
        # nondiag_sequences[2].append(([], max_time - hard_pi_t - t_rot - mw_pi2_rf - mw_pi))
        heating_time.append(max_time - hard_pi_t - t_rot - mw_pi2_rf - mw_pi)

        "rho14 -pi/2"
        nondiag_sequences[3] += hard_pi_seq
        nondiag_sequences[3].append(([], t_rot))
        nondiag_sequences[3].append(([], mw_pi2_rf))
        nondiag_sequences[3].append((["A", "mw_x"], mw_pi))
        # nondiag_sequences[3].append(([], max_time - hard_pi_t - t_rot - mw_pi2_rf - mw_pi))
        heating_time.append(max_time - hard_pi_t - t_rot - mw_pi2_rf - mw_pi)
    ...
    def VQE_wfm_rf(self, j):
        ...
        pulse_rot = [rot_ny, zero_rf, rot_nx]
