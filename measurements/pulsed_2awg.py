...
class Pulsed( ManagedJob, GetSetItemsMixin ):
    ...
    vpp1       = Range(low=0.0, high=2.0, value=1.0, label='vpp CH1 [V]', desc='Set output voltage peak to peak [V] of CH1.', mode='text', auto_set=False, enter_set=True)
    vpp2       = Range(low=0.0, high=2.0, value=1.0, label='vpp CH2 [V]', desc='Set output voltage peak to peak [V] of CH2.', mode='text', auto_set=False, enter_set=True)
    trig_interval = Range(low=11.0, high=10000.0, value=40.0, label='Trig Interval', desc='Set the trigger duration for the AWG.', mode='text', auto_set=False, enter_set=True)
    trig_delay = Range(low=11.0, high=10000.0, value=50.0, label='Trig Delay', desc='Trigger delay of the AWG.', mode='text', auto_set=False, enter_set=True)
    ...
    trig_delay_rf = Range(low=11.0, high=10000.0, value=440, label='Trig Delay rf', desc='Trigger delay of the AWG.', mode='text', auto_set=False, enter_set=True)
    ...
    power = Range(low=-100.,  high=25.,   value=13,      desc='microwave power',     label='power [dBm]',    mode='text', auto_set=False, enter_set=True)
