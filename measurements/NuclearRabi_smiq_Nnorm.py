...
class NuclearRabi_smiq_Nnorm( Pulsed ):
    ...
    def generate_sequence(self):
        ...
        sequence = [
            ([], max_time + trig_interval_rf + trig_delay_rf + mw_pi + mw_pi - 100),
            (['aom'], laser),
            (['aom'], (576 + 120000) * 1e9 /self.sampling_rf + 450 ),
            ([], wait )
        ]
        
        sequence.append(([], max_time + trig_interval_rf + trig_delay_rf + mw_pi + mw_pi))
        ...
        sequence.append(([], max_time - mw_pi_rf))
        sequence.append((['awg_rf','ch2'],  trig_interval_rf))
