...
class VQE_2p(Pulsed):
    ...
    def VQE_wfm_rf(self,j):
        ...
        if j == 0:
            ...
            'rho23 +pi/2'
            pulse_sequence_rf = [carry_hard_pi] + pulse_rot + [carry_hard_pi_2] + pi2y_rf_p + [carry_makeup2, carry_wait, carry_pi13, carry_wait] + [rf_heating] + [zero_rf]
            name_rf = 'VQE_rho23_p'
            wave_rf = Waveform610(name_rf, pulse_sequence_rf, offset=0, file_type=0, sampling=self.sampling_rf)# 0 for wfm file and 1 for pat file
            ...
            'rho23 -pi/2'
            pulse_sequence_rf = [carry_hard_pi] + pulse_rot + [carry_hard_pi_2] + pi2y_rf_m + [carry_makeup2, carry_wait, carry_pi13, carry_wait] + [rf_heating] + [zero_rf]
            name_rf = 'VQE_rho23_m'
            wave_rf = Waveform610(name_rf, pulse_sequence_rf, offset=0, file_type=0, sampling=self.sampling_rf)# 0 for wfm file and 1 for pat file
