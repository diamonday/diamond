...
class NuclearRabi_smiq_Nnorm( Pulsed ):
    ...
    def generate_sequence(self):
        ...
        sequence = [
            ...
            ([], trig_delay_rf),
            ([], max_time + hard_pi_t + mw_pi + mw_pi_rf - 100),#consider (['sequence'], 100)
            (['aom'], laser),
        ...
        sequence.append(([], max_time + hard_pi_t + mw_pi + mw_pi_rf)) # the typical time between the laser illumination is : wait + max_time + trig_interval_rf + trig_delay_rf + hard_pi_t + mw_pi + mw_pi_rf
    ...
    def compile_waveforms(self):
        ...
        for i,t in enumerate(self.tau):
            ...
            rf_heating.duration = int(int(heating_time/T_heating) * T_heating)
            pulse_sequence_rf = [carry] + [mw_rf] + [carry_pi13] + [rf_heating] + [zero_rf]
            ...
            rf_heating.duration = int(int(heating_time/T_heating) * T_heating)
            pulse_sequence_rf = [carry] + [mw_rf] + [carry_pi13] + [mw_rf_pi34] + [rf_heating] + [zero_rf]
            ...
            rf_heating.duration = int(int(heating_time/T_heating) * T_heating)
            pulse_sequence_rf = [carry] + [mw_rf] + [carry_pi24] + [rf_heating] + [zero_rf]
