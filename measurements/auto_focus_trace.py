...
class AutoFocusTrace( ManagedJob, GetSetItemsMixin ):
    ...
    delay = Range(low=0.0, high=60.0, value=0.0, desc='Delay before starting auto focus', label='Delay [s]', mode='text', auto_set=False, enter_set=True)
    ...
    count_trace               = Array( value=np.array(((0,0,0,),)) )
    ...
    def __init__(self, confocal):
        ...
        self.on_trait_change(self.update_plot_count_trace_value, 'count_trace', dispatch='ui')
        self.on_trait_change(self.update_plot_count_trace_index, 'count_trace_time', dispatch='ui')
    ...
    def _run(self):
        ...
        try:
            ...
            if self.current_target is None:
                ...
                self.current_count_trace = np.array((self.data_z.max()/1000., 0., 0.))
                self.count_trace = np.append(self.count_trace, (self.current_count_trace,), axis=0)
    ...
    def _figure_count_trace_default(self):
        plot = Plot(self.plot_data_count_trace, width=100, height=100, padding=8, padding_left=64, padding_bottom=32)
    ...
    traits_view = View(VGroup(HGroup(Item('submit_button', show_label=False),
                       ...
                       menubar = MenuBar(Menu(Action(action='save', name='Save (.pyd or .pys)'),
                                         ...
                                         Menu(Action(action='remove_all_targets', name='Remove All'),
                                              ...
                                              name='Target'),),
                       title='Auto Focus with Trace', width=500, height=700, buttons=[], resizable=True, x=1920-500, y=0 ,
    ...
    get_set_items=['confocal','targets','current_target','current_drift','drift','drift_time','periodic_focus',
                   ...
                   'data_xy', 'data_z', 'X', 'Y', 'Z', 'focus_interval', 'delay','current_count_trace','count_trace','count_trace_time' ]
