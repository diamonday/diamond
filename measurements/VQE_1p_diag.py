...
class VQE_1p_diag(Pulsed):
    ...
    def __init__(self, pulse_generator, time_tagger, microwave, microwave2, awg_rf, **kwargs):
        ...
        super(VQE_1p_diag, self).__init__(pulse_generator, time_tagger, microwave, microwave2, awg_rf, **kwargs)
    ...
    get_set_items = Pulsed.get_set_items + [ 'y1', 'spin_state', 'rot_n_y', 'rot_n_x','rot_e_y', 'rot_e_x', 'main_dir_rf', 'amp1_rf','amp_rf_34','amp_rf_12', 'freq_rf_34', 'freq_rf_12',  't_2pi_rf_34', 't_2pi_rf_12', 't_2pi_mw_13',  't_2pi_mw_24', 'freq_awg_rf_heating']
