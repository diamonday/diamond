...
class VQE_1p_diag(Pulsed):
    ...
    # todo: 2smiq instead of awg520;
    #      1 point instead of 5 for gradient
    #      considering heating, add heating balance rf
    #      the order of sequence is a mess, need to get to N1 N2 N3 N4, N0, Npi13, Npi34, NPi and off diad terms. this is also needed in data processing part
    ...
    def __init__(
        ...
        super(VQE_1p_diag, self).__init__(
    ...
    def generate_heating_time(self):
        ...
        if hard_pi_t + t_rot + mw_pi + mw_pi_rf < mw_pi_rf_12:
            max_time = mw_pi_rf_12
        else:
            max_time = hard_pi_t + t_rot + mw_pi + mw_pi_rf
    ...
    def generate_sequence(self):
        ...
        sequences = norm_sequences + diag_sequences
    ...
    def _create_line_plot(self):
        ...
        self.index_range = DataRange1D(
            self.x_data, low_setting=-0.5, high_setting=7.5, stretch_data=False
        )
