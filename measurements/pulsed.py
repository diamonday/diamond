...
def sequence_remove_zeros(sequence):
    return [x for x in sequence if x[1] != 0.0]
...
class Pulsed(ManagedJob, GetSetItemsMixin):
    ...
    def _run(self):
        ...
        try:  # try to run the acquisition from start_up to shut_down
            ...
            tagger_0 = TimeTagger.Pulsed(
                self.n_bins, int(np.round(self.bin_width * 1000)), self.n_laser, 0, 2, 3
            )
            tagger_1 = TimeTagger.Pulsed(
                self.n_bins, int(np.round(self.bin_width * 1000)), self.n_laser, 1, 2, 3
            )
            ...
            while self.run_time < self.stop_time:
                ...
                if PulseGenerator().checkUnderflow():
                    ...
                    PulseGenerator().Sequence(self.sequence)
                self.count_data = (
                    self.old_count_data + tagger_0.getData() + tagger_1.getData()
                )
...
class Rabi(PulsedTau):
    ...
    switch = Enum(
        ...
        label="switch",
        editor=EnumEditor(cols=3, values={"mw": "1:X", "mw_y": "2:Y"}),
    )
...
class PulseCal(Pulsed):
    ...
    switch = Enum(
        ...
        desc="switch to use for microwave pulses",
        label="switch",
        editor=EnumEditor(cols=3, values={"mw_x": "1:X", "mw_y": "2:Y"}),
    )
    ...
    pulse = Range(
        ...
        high=100000.0,
        value=1000.0,
        desc="Length of the Pulse that is Calibrated",
        label="pulse [ns]",
        mode="text",
        auto_set=False,
        enter_set=True,
        ...
        VGroup(
            ...
            Tabbed(
                VGroup(
                    ...
                    HGroup(
                        Item("pulse", width=-80, enabled_when='state != "run"'),
...
class Pi2PiCal(Pulsed):
    ...
    n_ref = Range(
        ...
        high=100,
        value=10,
        desc="number of reference pulses",
        label="n ref",
        mode="text",
        auto_set=False,
        enter_set=True,
...
class CPMG3pi2(Rabi):
    ...
    get_set_items = Rabi.get_set_items + [
        "t_pi2_x",
        "t_pi_y",
        "t_3pi2_x",
        "n_pi",
...
class PulPol_Sweep(Rabi):
    ...
    t_mix = Range(
        ...
        high=1.0e9,
        value=1.0e6,
        desc="duration for depolarizing",
        label="mix[ns]",
        mode="text",
        auto_set=False,
        enter_set=True,
    ...
    repetition = Range(
        ...
        high=100,
        value=30,
        desc="number of repetition for the mix sequence",
        label="repetition",
        mode="text",
        auto_set=False,
        enter_set=True,
    ...
    def generate_sequence(self):
        ...
        for t in tau:
            ...
            mixSeq = ([(["aom"], laserTime_pp), ([], wait_pp)] + PI2_X + DDseq) * int(
                repetition
            )
...
class CPMGxy(Rabi):
    ...
    t_pi_y = Range(
        ...
        high=100000.0,
        value=1000.0,
        desc="pi pulse length (y, 90 degree)",
        label="pi y [ns]",
        mode="text",
        auto_set=False,
        enter_set=True,
...
class T1Meta(Rabi):
    ...
    delay = Range(
        ...
        high=1000.0,
        value=450.0,
        desc="delay of AOM relative to trigger",
        label="AOM delay [ns]",
        mode="text",
        auto_set=False,
        enter_set=True,
...
class FID3pi2_200laser(Rabi):
    ...
    more_laser = Range(
        ...
        high=100000.0,
        value=1000.0,
        desc="laser time before readout (x)",
        label="more laser [ns]",
        mode="text",
        auto_set=False,
        enter_set=True,
    ...
    more_wait = Range(
        ...
        high=100000.0,
        value=1000.0,
        desc="wait time before readout (x)",
        label="more wait [ns]",
        mode="text",
        auto_set=False,
        enter_set=True,
...
class DQTFID3pi2(Pulsed):
    ...
    frequency_a = Range(
        ...
        high=20e9,
        value=2.8705e9,
        desc="microwave frequency A",
        label="frequency A [Hz]",
        mode="text",
        auto_set=False,
        enter_set=True,
    )
    frequency_b = Range(
        ...
        high=20e9,
        value=2.8705e9,
        desc="microwave frequency B",
        label="frequency B [Hz]",
        mode="text",
        auto_set=False,
        enter_set=True,
    )
    ...
    traits_view = View(
        VGroup(
            ...
            Tabbed(
                VGroup(
                    HGroup(
                        Item("frequency_a", width=-80, enabled_when='state != "run"'),
                    ...
                    HGroup(
                        Item("frequency_b", width=-80, enabled_when='state != "run"'),
...
class DQTRabi(Pulsed):
    ...
    tau_a = Range(
        ...
        high=100000.0,
        value=1000.0,
        desc="hahn echo wait time for A",
        label="Tau A [ns]",
        mode="text",
        auto_set=False,
        enter_set=True,
...
class DEER(Pulsed):
    ...
    mw1_frequency = Range(
        ...
        high=20.0e9,
        value=2.61e9,
        desc="MW1 frequency [Hz]",
        label="MW1 frequency [Hz]",
        mode="text",
        auto_set=False,
        enter_set=True,
    )
    t_mw1_pi2 = Range(
        ...
        high=100000.0,
        value=83.0,
        desc="length of pi/2 pulse of mw1 [ns]",
        label="mw1 pi/2 [ns]",
        mode="text",
        auto_set=False,
        enter_set=True,
    ...
    t_mw1_pi = Range(
        ...
        high=100000.0,
        value=166.0,
        desc="length of pi pulse of mw1 [ns]",
        label="mw1 pi [ns]",
        mode="text",
        auto_set=False,
        enter_set=True,
    ...
    t_mw2_pi = Range(
        ...
        high=100000.0,
        value=90.0,
        desc="length of pi pulse of mw2 [ns]",
        label="mw2 pi [ns]",
        mode="text",
        auto_set=False,
        enter_set=True,
    ...
    frequencies = Array(value=np.array((0.0, 1.0)))
    ...
    def generate_sequence(self):
        if self.t_mw1_pi > self.t_mw2_pi:
            return 100 * [
                ...
                (["mw_a"], self.t_mw1_pi2),
                ([], self.tau),
                (["mw_a", "mw_b"], self.t_mw2_pi),
                (["mw_a"], (self.t_mw1_pi - self.t_mw2_pi)),
                ([], self.tau),
                (["mw_a"], self.t_mw1_pi2),
                (["sequence"], 10),
            ]
            ...
            return 100 * [
                ...
                (["mw_a"], self.t_mw1_pi2),
                ([], self.tau),
                (["mw_a", "mw_b"], self.t_mw1_pi),
                (["mw_b"], (self.t_mw2_pi - self.t_mw1_pi)),
                ([], (self.tau - (self.t_mw2_pi - self.t_mw1_pi))),
                (["mw_a"], self.t_mw1_pi2),
                (["sequence"], 10),
            ]
    ...
    def apply_parameters(self):
        ...
        frequencies = np.arange(
            self.rf_begin, self.rf_end + self.rf_delta, self.rf_delta
        )
        n_bins = int(self.record_length / self.bin_width)
        time_bins = self.bin_width * np.arange(n_bins)
        sequence = self.generate_sequence()
    ...
    def _run(self):
        ...
        try:  # try to run the acquisition from start_up to shut_down
            ...
            tagger = TimeTagger.Pulsed(
                self.n_bins, int(np.round(self.bin_width * 1000)), 1, 0, 2, 3
            )
            ...
            Tabbed(
                VGroup(
                    HGroup(
                        ...
                        Item(
                            "mw1_frequency", width=-120, enabled_when='state != "run"'
                        ),
...
class DEER3pi2(Pulsed):
    ...
    t_mw1_3pi2 = Range(
        ...
        high=100000.0,
        value=250.0,
        desc="length of 3pi/2 pulse of mw1 [ns]",
        label="mw1 3pi/2 [ns]",
        mode="text",
        auto_set=False,
        enter_set=True,
    ...
    def _run(self):
        ...
        try:  # try to run the acquisition from start_up to shut_down
            ...
            MicrowaveB().setPower(self.mw2_power)
            tagger = TimeTagger.Pulsed(
                self.n_bins, int(np.round(self.bin_width * 1000)), 2, 0, 2, 3
            )
            tagger.setMaxCounts(self.sweeps_per_point)
            PulseGenerator().Sequence(self.sequence)
...
class Ce_DEER(Pulsed):
    ...
    mw0_frequency = Range(
        ...
        high=20.0e9,
        value=1.34855e9,
        desc="MW0 frequency [Hz]",
        label="MW0 frequency [Hz]",
        mode="text",
        auto_set=False,
        enter_set=True,
    )
    ...
    def generate_sequence(self):
        ...
        for t in tau:
            sequence = sequence + [
                (["mw_x", "mw", "mw_c"], self.t_mw2_pi2),
                ([], t / (self.n_pi * 2.0)),
            ]
            # sequence.append(((['mw_x', 'mw', 'mw_c'], self.t_mw2_pi2),([], t/(self.n_pi*2.0))))
            sequence = sequence + int(self.n_pi - 1) * [
                (["mw_x", "mw", "mw_c"], self.t_mw2_pi),
                ([], t / (self.n_pi)),
            ]
        ...
        VGroup(
            ...
            Tabbed(
                VGroup(
                    ...
                    HGroup(
                        Item(
                            "mw0_frequency", width=-120, enabled_when='state != "run"'
                        ),
