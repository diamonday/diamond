...
class NuclearRabi( Pulsed ):
    ...
    get_set_items = Pulsed.get_set_items + [ 'freq_awg', 'amp1', 'show_fit', 'fit_parameters', 'rabi_frequency', 'rabi_period',
    ...
    def compile_waveforms(self):
        ...
        f2 = (self.freq_awg - 2160000)/self.sampling
        mw2 = Sin(mw_pi, freq=f2, amp=self.amp1, phase=phase)
        pulse_sequence2 = [zero, mw2, zero]
        name2 = 'NRABI_pi_2' 
