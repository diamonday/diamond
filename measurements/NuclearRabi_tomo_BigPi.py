...
class NuclearRabi_smiq_Nnorm(Pulsed):
    ...
    mw_pi_2 = Range(
        ...
        high=100000.0,
        value=600,
        desc="length of mw pi pulse of the second smiq[ns]",
        label="mw_pi 2 [ns]",
        mode="text",
        auto_set=False,
        enter_set=True,
    ...
    def __init__(
        ...
        self.dual = False
        super(NuclearRabi_smiq_Nnorm, self).__init__(
    ...
    def generate_sequence(self):
        ...
        )  # the typical time between the laser illumination is : wait + max_time + trig_interval_rf + trig_delay_rf + mw_pi + mw_pi_2 + mw_pi_rf
        ...
        "N3"
        sequence.append(
            ([], max_time + trig_interval_rf + trig_delay_rf + mw_pi_2 + mw_pi_rf)
        )
        sequence.append((["A", "mw_x"], mw_pi))
        sequence.append((["laser", "aom"], laser))
        sequence.append(
    ...
    def compile_waveforms(self):
        ...
        pulse_sequence_rf_tomo_pi34 = (
            [carry] + [mw_rf_tomo_pi34] + [carry_pi13] + [mw_rf_pi34] + [zero_rf]
        )
