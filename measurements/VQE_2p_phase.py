...
class VQE_2p(Pulsed):
    ...
    phase_23 = Range(low=-100.0, high=100.0, value=0.0, desc='the phase change for rho23 term measurement', label='Phase 23', mode='text', auto_set=False, enter_set=True, editor=TextEditor(auto_set=False, enter_set=True, evaluate=float, format_str='%e'))
    phase_14 = Range(low=-100.0, high=100.0, value=0.0, desc='the phase change for rho23 term measurement', label='Phase 14', mode='text', auto_set=False, enter_set=True, editor=TextEditor(auto_set=False, enter_set=True, evaluate=float, format_str='%e'))
