...
from traits.api import Range, Int, Float, Complex, Bool, Tuple, Array, Str, Instance, Property, Enum, on_trait_change, Button, DelegatesTo
...
class SNSCXYn(measurePulsed, ManagedJob, GetSetItemsMixin):
    ...
    def generate_sequence(self):
        ...
        n_pi = self.n_pi
        N_ref = self.n_ref
        if self.tau_DD>=t_pi_x:
            tau_DD = self.tau_DD - t_pi_x
        else:
            tau_DD = 0.0
        ...
        if self.polarizeNspinPuPol and (self.polarizeNspinSSR == False):
            ...
            tDD = tau_PuPol-(t_pi2_y+t_pi2_x)*2.0-(t_pi_x+t_pi_y)*1.0
            if tDD < 0:
                tDD = 0
            else:
                tDD = tDD
            DDseq = [ (['mw_x'], t_pi2_x), ([], tDD/4.0), (['mw_y'], t_pi_y), ([], tDD/4.0), (['mw_x'], t_pi2_x),
                        (['mw_y'], t_pi2_y), ([], tDD/4.0), (['mw_x'], t_pi_x), ([], tDD/4.0), (['mw_y'], t_pi2_y)]*repetition_P 
        ...
        for tau_f in tau_f_seq: #symmetric correlation
            ...
            sequence += [ (['mw_x', 'rf'], t_pi2_x)]
            sequence += [ (['rf'], tau_DD/2.0), (['mw_x', 'rf'], t_pi_x), (['rf'], tau_DD), (['mw_y', 'rf'], t_pi_y), (['rf'], tau_DD/2.0)  ] * int(n_pi / 4)
            sequence += [ (['rf'], tau_DD/2.0), (['mw_y', 'rf'], t_pi_y), (['rf'], tau_DD), (['mw_x', 'rf'], t_pi_x), (['rf'], tau_DD/2.0)  ] * int(n_pi / 4)
            #sequence += [ ([], tau_DD/2.0), (['mw_x'], t_pi_x), ([], tau_DD/2.0)  ] #1/4
            sequence += [ (['mw_y', 'rf'], t_pi2_y * 5.0)] # 2/2 5

            sequence += [ ([], tau_f/2.0 - t_pi2_y) ]
            ...
            sequence += [ (['rf'], tau_DD/2.0), (['mw_x', 'rf'], t_pi_x), (['rf'], tau_DD), (['mw_y', 'rf'], t_pi_y), (['rf'], tau_DD/2.0)  ] * int(n_pi / 4)
            sequence += [ (['rf'], tau_DD/2.0), (['mw_y', 'rf'], t_pi_y), (['rf'], tau_DD), (['mw_x', 'rf'], t_pi_x), (['rf'], tau_DD/2.0)  ] * int(n_pi / 4)
            # sequence += [ ([], tau_DD/2.0), (['mw_x'], t_pi_x), ([], tau_DD/2.0)  ] #2/4
            sequence += [ (['mw_y', 'rf'], t_pi2_y)]
            #enhancement
            sequence += re
        ...
        if self.doSorSNS == "SandNS":
            for tau_f in tau_f_seq: #non-symmetric correlation
                ...
                sequence += [ (['rf'], tau_DD/2.0), (['mw_x', 'rf'], t_pi_x), (['rf'], tau_DD), (['mw_y', 'rf'], t_pi_y), (['rf'], tau_DD/2.0)  ] * int(n_pi / 4)
                sequence += [ (['rf'], tau_DD/2.0), (['mw_y', 'rf'], t_pi_y), (['rf'], tau_DD), (['mw_x', 'rf'], t_pi_x), (['rf'], tau_DD/2.0)  ] * int(n_pi / 4)
                # sequence += [ ([], tau_DD/2.0), (['mw_x'], t_pi_x), ([], tau_DD/2.0)  ] #3/4
                sequence += [ (['mw_y', 'rf'], t_pi2_y * 4.0)] # 4.0
                sequence += [ ([], t_pi2_y )]
                ...
                sequence += [ (['rf'], tau_DD/2.0), (['mw_x', 'rf'], t_pi_x), (['rf'], tau_DD), (['mw_y', 'rf'], t_pi_y), (['rf'], tau_DD/2.0)  ] * int(n_pi / 4)
                sequence += [ (['rf'], tau_DD/2.0), (['mw_y', 'rf'], t_pi_y), (['rf'], tau_DD), (['mw_x', 'rf'], t_pi_x), (['rf'], tau_DD/2.0)  ] * int(n_pi / 4)
                # sequence += [ ([], tau_DD/2.0), (['mw_x'], t_pi_x), ([], tau_DD/2.0)  ] #4/4
                sequence += [ (['mw_y', 'rf'], t_pi2_y)]
        ...
        sequence += N_ref * ([ (['mw_x'], t_pi2_x*2.0)] + re + [(['laser', 'aom'], laserTime), ([], wait)]) #dark
