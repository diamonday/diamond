...
class NMR(Pulsed):
    ...
    mw_t_pi = Range(
        ...
        high=100000.0,
        value=1147.0,
        desc="length of pi pulse of MW[ns]",
        label="MW pi [ns]",
        mode="text",
        auto_set=False,
        enter_set=True,
    ...
    switch = Enum(
        "rf_1", "rf_2", desc="switch to use for different RF source", label="switch"
    )
    rf_power = Range(
        low=-130.0,
        high=20.0,
