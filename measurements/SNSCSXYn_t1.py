...
class SNSCXYn_t1(measurePulsed, ManagedJob, GetSetItemsMixin):
    '''
    +======================================================================================================+
    |           SNSCXYn: symmetric correlation spectroscopies                               |
    ...
    def __init__(self):
        super(SNSCXYn_t1, self).__init__()
    ...
    traits_view = View(
                       ...
                       title='Symmetric t1 correlation spectrum XYn',
                       width=1350,  
                       resizable=True,
                       handler=SNSCHandler,
                       )