...
from traitsui.api import View, Item, Group, HGroup, VGroup, VSplit, Action, Menu, MenuBar
    ...
    def focus(self):
            ...
            for i, y in enumerate(Y):
                ...
                if i%2 != 0:
                    ...
                    XL = X
                YL = y * np.ones(X.shape)   # for a horizontal line, we now iterate its y coordinate
