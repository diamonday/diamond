...
class VQE(Pulsed):
    ...
    def generate_sequence(self):
        ...
        if self.check_state:
            i_range = 1
            max_time_rottome = t_2pi_rot_e/2 + t_rot + t_2pi_mw_13/2 + t_2pi_rf_34/2
        else:
            i_range = 5
            max_time_rottome = t_2pi_rot_e/2 + t_rot + t_2pi_rf_34/4 + t_2pi_mw_13/2 + t_2pi_rf_34/2 # the longest pulse

        max_time_norm_pol = t_2pi_rf_34/2 + t_2pi_rot_e/2 + t_2pi_rf_34/2 + t_2pi_mw_24/2 #the third of pol_sequences
