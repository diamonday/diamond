...
class Tomo(Pulsed):
    ...
    def start_up(self):
        ...
        if self.on_AWG:
            ...
            self.microwave.setOutput(
                self.power, self.freq + self.offset + self.detuning
            )
