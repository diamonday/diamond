...
class SNSCXYn2(measurePulsed, ManagedJob, GetSetItemsMixin):
    '''
    +======================================================================================================+
...
# add mw_x to check pulse error
        Unit_X = [(['mw_x'], tDD), (['mw_x'], t_pi_x), (['mw_x'], tDD)]
        Unit_Y = [(['mw_x'], tDD), (['mw_y'], t_pi_y), (['mw_x'], tDD)]
