...
class VQE_2p(Pulsed):
    ...
    phase_23 = Range(
        ...
        high=10.0,
        value=0.0,
        desc="the phase change for rho23 term measurement",
        label="Phase 23",
        mode="text",
        auto_set=False,
        enter_set=True,
    ...
    phase_14 = Range(
        ...
        high=10.0,
        value=0.0,
        desc="the phase change for rho14 term measurement",
        label="Phase 14",
        mode="text",
        auto_set=False,
        enter_set=True,
    ...
    def VQE_wfm_rf(self, j):
        ...
        phase_p_23 = np.pi / 2.0 + phase_23
        pi2y_rf_p_23 = [
            Sin(duration_pi2y_rf, freq=freq_rf_34, amp=self.amp_rf_34, phase=phase_p_23)
        ]
        phase_m_23 = np.pi * 3 / 2.0 + phase_23
        pi2y_rf_m_23 = [
            Sin(duration_pi2y_rf, freq=freq_rf_34, amp=self.amp_rf_34, phase=phase_m_23)
        ]
        phase_p_14 = np.pi / 2.0 + phase_14
        pi2y_rf_p_14 = [
            Sin(duration_pi2y_rf, freq=freq_rf_34, amp=self.amp_rf_34, phase=phase_p_14)
        ]
        phase_m_14 = np.pi * 3 / 2.0 + phase_14
        pi2y_rf_m_14 = [
            Sin(duration_pi2y_rf, freq=freq_rf_34, amp=self.amp_rf_34, phase=phase_m_14)
        ]
        ...
        phase_rot_y = np.pi / 2.0 + rf_y_dir * np.pi
        rot_ny = Sin(
            rot_ny_duration, freq=freq_rf_34, amp=self.amp_rf_34, phase=phase_rot_y
        )
        phase_rot_x = rf_x_dir * np.pi
        rot_nx = Sin(
            rot_nx_duration, freq=freq_rf_34, amp=self.amp_rf_34, phase=phase_rot_x
        )
