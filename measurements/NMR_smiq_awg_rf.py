...
class NMR_awg( Pulsed ):
    ...
    start_freq = Range(low=1, high=2.6e9, value=2.929e6, desc='AWG_rf frequency', label='start freq [Hz]', mode='text', auto_set=False, enter_set=True, editor=TextEditor(auto_set=False, enter_set=True, evaluate=float, format_str='%e'))
    end_freq   = Range(low=1, high=2.6e9, value=2.945e6, desc='AWG_rf frequency', label='end freq [Hz]', mode='text', auto_set=False, enter_set=True, editor=TextEditor(auto_set=False, enter_set=True, evaluate=float, format_str='%e'))
    ...
    get_set_items = Pulsed.get_set_items + [ 'mw_pi', 'mw_pi_rf',  'start_freq',  'end_freq',  'freq_step', 
    ...
    def __init__(self, pulse_generator, time_tagger, microwave, awg_rf, **kwargs):
        self.dual = False
        super(NMR_awg, self).__init__(pulse_generator, time_tagger, microwave, awg_rf, **kwargs)
        self.show_fit = True
