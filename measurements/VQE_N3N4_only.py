...
class VQE_N3N4_only(Pulsed):
    ...
    def __init__(self, pulse_generator, time_tagger, microwave, awg, awg_rf, **kwargs):
        ...
        super(VQE_N3N4_only, self).__init__(
    ...
    def generate_sequence(self):
        ...
        norm_sequences.append(([], t_2pi_rot_e / 2 + 50000))  # N3
        norm_sequences.append(([], t_2pi_rot_e / 2 + t_2pi_rf_34 / 2))  # N4
        norm_sequences.append(
            ([], t_2pi_rot_e / 2 + t_2pi_rf_34 / 2 + t_2pi_rot_e / 2)
        )  # N2

        # polarization rates
        pol_sequences = []
        pol_sequences.append(
            ([], t_2pi_rf_34 / 2 + t_2pi_rot_e / 2)
        )  # first pi_34 then Big Pi, for e
        pol_sequences.append(([], t_2pi_mw_24 / 2))  # pi_24 for n
        pol_sequences.append(
            ([], t_2pi_rf_34 / 2 + t_2pi_rot_e / 2 + t_2pi_rf_34 / 2 + t_2pi_mw_24 / 2)
        )  # pi_34, Big Pi, pi_34, pi_24, for n
        pol_sequences.append(
            ([], t_2pi_rf_34 / 2 + t_2pi_rot_e / 2 + t_2pi_rf_34 / 2)
        ...
        for i in range(i_range):  # 5 for self and 2 gradient*2
            ...
            for j in range(2):  # 4 fluorescence rates of the different levels
    ...
    def compile_waveforms(self):
        ...
        for i in range(i_range):
            ...
            for j in range(2):
                sub, sub_waves, sub_rf, sub_waves_rf = self.VQE_wfm(i, j + 1)
    ...
    def _create_line_plot(self):
        ...
        self.index_range = DataRange1D(
            self.x_data, low_setting=-0.5, high_setting=1.5, stretch_data=False
        )
