...
class VQE_N3N4_only(Pulsed):
    ...
    def __init__(self, pulse_generator, time_tagger, microwave, awg, awg_rf, **kwargs):
        ...
        super(VQE_N3N4_only, self).__init__(pulse_generator, time_tagger, microwave, awg, awg_rf, **kwargs)
    ...
    def _create_line_plot(self):
        ...
        self.index_range = DataRange1D(self.x_data, low_setting=-0.5, high_setting=1.5, stretch_data=False)
