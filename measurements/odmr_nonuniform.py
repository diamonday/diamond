...
class ODMRN(ManagedJob, GetSetItemsMixin):
    ...
    frequency_begin1 = Range(low=1, high=20e9, value=2.85e9, desc='Start Frequency region1 [Hz]', label='Begin region1 [Hz]', editor=TextEditor(auto_set=False, enter_set=True, evaluate=float, format_str='%e'))
    frequency_end1 = Range(low=1, high=20e9, value=2.90e9, desc='Stop Frequency region1 [Hz]', label='End region1 [Hz]', editor=TextEditor(auto_set=False, enter_set=True, evaluate=float, format_str='%e'))
    frequency_delta1 = Range(low=1e-3, high=20e9, value=1e6, desc='frequency step region1 [Hz]', label='Delta region1 [Hz]', editor=TextEditor(auto_set=False, enter_set=True, evaluate=float, format_str='%e'))
    frequency_begin2 = Range(low=1, high=20e9, value=2.85e9, desc='Start Frequency region2 [Hz]', label='Begin region2 [Hz]', editor=TextEditor(auto_set=False, enter_set=True, evaluate=float, format_str='%e'))
    frequency_end2 = Range(low=1, high=20e9, value=2.90e9, desc='Stop Frequency region2 [Hz]', label='End region2 [Hz]', editor=TextEditor(auto_set=False, enter_set=True, evaluate=float, format_str='%e'))
    frequency_delta2 = Range(low=1e-3, high=20e9, value=1e6, desc='frequency step region2 [Hz]', label='Delta region2 [Hz]', editor=TextEditor(auto_set=False, enter_set=True, evaluate=float, format_str='%e'))
    frequency_begin3 = Range(low=1, high=20e9, value=2.85e9, desc='Start Frequency region3 [Hz]', label='Begin region3 [Hz]', editor=TextEditor(auto_set=False, enter_set=True, evaluate=float, format_str='%e'))
    frequency_end3 = Range(low=1, high=20e9, value=2.90e9, desc='Stop Frequency region3 [Hz]', label='End region3 [Hz]', editor=TextEditor(auto_set=False, enter_set=True, evaluate=float, format_str='%e'))
    frequency_delta3 = Range(low=1e-3, high=20e9, value=1e6, desc='frequency step region3 [Hz]', label='Delta region3 [Hz]', editor=TextEditor(auto_set=False, enter_set=True, evaluate=float, format_str='%e'))
    ...
    def _frequency_default(self):
        if self.pulsed:
            ...
            nonuniformlist = np.arange(self.frequency_begin1, self.frequency_end1 + self.frequency_delta1, self.frequency_delta1)
            nonuniformlist = np.append(nonuniformlist, np.arange(self.frequency_begin2, self.frequency_end2 + self.frequency_delta2, self.frequency_delta2))
            nonuniformlist = np.append(nonuniformlist, np.arange(self.frequency_begin3, self.frequency_end3 + self.frequency_delta3, self.frequency_delta3))
    ...
    def apply_parameters(self):
        ...
        if self.pulsed:
            ...
            frequency = np.arange(self.frequency_begin1, self.frequency_end1 + self.frequency_delta1, self.frequency_delta1)
            frequency = np.append(frequency, np.arange(self.frequency_begin2, self.frequency_end2 + self.frequency_delta2, self.frequency_delta2))
            frequency = np.append(frequency, np.arange(self.frequency_begin3, self.frequency_end3 + self.frequency_delta3, self.frequency_delta3))
            print (frequency)
    ...
    traits_view = View(VGroup(HGroup(Item('submit_button', show_label=False),
                       ...
                       menubar=MenuBar(Menu(Action(action='saveLinePlot', name='SaveLinePlot (.png)'),
                                              ...
                                              name='File')),
                       title='ODMRN', width=900, height=800, buttons=[], resizable=True, handler=ODMRHandler
                       )
    ...
    get_set_items = ['frequency', 'counts', 'counts_matrix',
                     ...
                     'power', 'frequency_begin1', 'frequency_end1', 'frequency_delta1', 'frequency_begin2', 'frequency_end2', 'frequency_delta2', 'frequency_begin3', 'frequency_end3', 'frequency_delta3',
...
class ODMRP(ManagedJob, GetSetItemsMixin):
    ...
    traits_view = View(VGroup(HGroup(Item('submit_button', show_label=False),
                       ...
                       menubar=MenuBar(Menu(Action(action='saveLinePlot', name='SaveLinePlot (.png)'),
                                              ...
                                              Action(action='_on_close', name='Quit'),
                                              name='File')),
                       title='ODMR_nonuniform', width=900, height=800, buttons=[], resizable=True, handler=ODMRHandler
                       )
