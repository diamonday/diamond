...
class VQE_2p(Pulsed):
    ...
    phase_23 = Range(low=-10., high=10., value=0.0, desc='the phase change for rho23 term measurement', label='Phase 23', mode='text', auto_set=False, enter_set=True)
    phase_14 = Range(low=-10., high=10., value=0.0, desc='the phase change for rho14 term measurement', label='Phase 14', mode='text', auto_set=False, enter_set=True)
