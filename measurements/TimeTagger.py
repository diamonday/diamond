...
class Tag(_object):
    ...
    if _newclass:
        overflow = _swig_property(
            _TimeTagger.Tag_overflow_get, _TimeTagger.Tag_overflow_set
        )
    __swig_setmethods__["chan"] = _TimeTagger.Tag_chan_set
    __swig_getmethods__["chan"] = _TimeTagger.Tag_chan_get
    if _newclass:
        chan = _swig_property(_TimeTagger.Tag_chan_get, _TimeTagger.Tag_chan_set)
    __swig_setmethods__["time"] = _TimeTagger.Tag_time_set
    __swig_getmethods__["time"] = _TimeTagger.Tag_time_get
    if _newclass:
        time = _swig_property(_TimeTagger.Tag_time_get, _TimeTagger.Tag_time_set)
...
DAC_channel_map = cvar.DAC_channel_map


class TimeTagger(_object):
    __swig_setmethods__ = {}
    ...
    def __init__(self, serial=""):
        this = _TimeTagger.new_TimeTagger(serial)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def sendDacCommand(self, *args):
        return _TimeTagger.TimeTagger_sendDacCommand(self, *args)
    ...
    def setLaserFilter(self, *args):
        return _TimeTagger.TimeTagger_setLaserFilter(self, *args)

    def getLaserFilter(self):
        return _TimeTagger.TimeTagger_getLaserFilter(self)

    def addIterator(self, *args):
        return _TimeTagger.TimeTagger_addIterator(self, *args)
    ...
    def iter(self, *args):
        return _TimeTagger.TimeTagger_iter(self, *args)
...
class _Iterator(_object):
    ...
    def _next(self, *args):
        return _TimeTagger._Iterator__next(self, *args)
...
class _Worker(_object):
    ...
    def terminate(self):
        return _TimeTagger._Worker_terminate(self)

    __swig_setmethods__["ibuffer"] = _TimeTagger._Worker_ibuffer_set
    __swig_getmethods__["ibuffer"] = _TimeTagger._Worker_ibuffer_get
    if _newclass:
        ibuffer = _swig_property(
            _TimeTagger._Worker_ibuffer_get, _TimeTagger._Worker_ibuffer_set
        )
    ...
    if _newclass:
        ifull_usage = _swig_property(
            _TimeTagger._Worker_ifull_usage_get, _TimeTagger._Worker_ifull_usage_set
        )
    __swig_setmethods__["obuffer"] = _TimeTagger._Worker_obuffer_set
    __swig_getmethods__["obuffer"] = _TimeTagger._Worker_obuffer_get
    if _newclass:
        obuffer = _swig_property(
            _TimeTagger._Worker_obuffer_get, _TimeTagger._Worker_obuffer_set
        )
    ...
    if _newclass:
        obuffer_usage = _swig_property(
            _TimeTagger._Worker_obuffer_usage_get, _TimeTagger._Worker_obuffer_usage_set
        )
    __swig_setmethods__["time"] = _TimeTagger._Worker_time_set
    __swig_getmethods__["time"] = _TimeTagger._Worker_time_get
    if _newclass:
        time = _swig_property(
            _TimeTagger._Worker_time_get, _TimeTagger._Worker_time_set
        )
...
class _Iter(_object):
    ...
    if _newclass:
        next = _swig_property(_TimeTagger._Iter_next_get, _TimeTagger._Iter_next_set)
    __swig_setmethods__["iter"] = _TimeTagger._Iter_iter_set
    __swig_getmethods__["iter"] = _TimeTagger._Iter_iter_get
    if _newclass:
        iter = _swig_property(_TimeTagger._Iter_iter_get, _TimeTagger._Iter_iter_set)

    def getMutex(self):
        return _TimeTagger._Iter_getMutex(self)
...
class Iterator(_Iterator):
    ...
    def __iter__(self):
        return _TimeTagger.Iterator___iter__(self)
...
class OverFlow(_Iterator):
    ...
    def __init__(self, *args):
        this = _TimeTagger.new_OverFlow(*args)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def clear(self):
        return _TimeTagger.OverFlow_clear(self)
    ...
    if _newclass:
        overflows = _swig_property(
            _TimeTagger.OverFlow_overflows_get, _TimeTagger.OverFlow_overflows_set
        )
...
class Chans(_Iterator):
    ...
    def __init__(self, *args):
        this = _TimeTagger.new_Chans(*args)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def registerChannel(self, *args):
        return _TimeTagger.Chans_registerChannel(self, *args)

    def unregisterChannel(self, *args):
        return _TimeTagger.Chans_unregisterChannel(self, *args)

    def clear(self):
        return _TimeTagger.Chans_clear(self)
...
class Distribution(_Iterator):
    ...
    def getData(self):
        return _TimeTagger.Distribution_getData(self)

    def clear(self):
        return _TimeTagger.Distribution_clear(self)
...
class _PulsedEdge(_object):
    ...
    if _newclass:
        edge = _swig_property(
            _TimeTagger._PulsedEdge_edge_get, _TimeTagger._PulsedEdge_edge_set
        )
    __swig_setmethods__["pulse"] = _TimeTagger._PulsedEdge_pulse_set
    __swig_getmethods__["pulse"] = _TimeTagger._PulsedEdge_pulse_get
    if _newclass:
        pulse = _swig_property(
            _TimeTagger._PulsedEdge_pulse_get, _TimeTagger._PulsedEdge_pulse_set
        )
...
class Pulsed(_Iterator):
    ...
    def start(self):
        return _TimeTagger.Pulsed_start(self)

    def getData(self):
        return _TimeTagger.Pulsed_getData(self)

    def setMaxCounts(self, *args):
        return _TimeTagger.Pulsed_setMaxCounts(self, *args)

    def getCounts(self):
        return _TimeTagger.Pulsed_getCounts(self)

    def ready(self):
        return _TimeTagger.Pulsed_ready(self)

    def clear(self):
        return _TimeTagger.Pulsed_clear(self)
...
class CountBetweenMarkers(_Iterator):
    ...
    def getData(self, blocking=0):
        return _TimeTagger.CountBetweenMarkers_getData(self, blocking)
