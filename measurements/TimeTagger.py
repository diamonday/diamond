...
class TimeTagger(_object):
    ...
    __del__ = lambda self : None;
    def sendDacCommand(self, *args): return _TimeTagger.TimeTagger_sendDacCommand(self, *args)
    def setTriggerLevel(self, *args): return _TimeTagger.TimeTagger_setTriggerLevel(self, *args)
    def getTriggerLevel(self, *args): return _TimeTagger.TimeTagger_getTriggerLevel(self, *args)
    def setLaserFilter(self, *args): return _TimeTagger.TimeTagger_setLaserFilter(self, *args)
    def getLaserFilter(self): return _TimeTagger.TimeTagger_getLaserFilter(self)
    def addIterator(self, *args): return _TimeTagger.TimeTagger_addIterator(self, *args)
    def registerChannel(self, *args): return _TimeTagger.TimeTagger_registerChannel(self, *args)
    def unregisterChannel(self, *args): return _TimeTagger.TimeTagger_unregisterChannel(self, *args)
    def getDistributionCount(self, *args): return _TimeTagger.TimeTagger_getDistributionCount(self, *args)
    def iter(self, *args): return _TimeTagger.TimeTagger_iter(self, *args)
