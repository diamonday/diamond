...
class Keithley2612(HasTraits):
    ...
    def _Measure_fired(self):
        self.ReadingV = np.float(self.k2612.ask("print(smua.measure.v())")) * 1000.0
        self.ReadingI = np.float(self.k2612.ask("print(smua.measure.i())")) * 1000.0
    ...
    traits_view = View(
        ...
        title="Keithley 2612 console(voltage mode)",
        width=600,
        height=150,
        buttons=[],
        resizable=True,
